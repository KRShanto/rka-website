        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <img src={logo || "/placeholder.svg"} alt={logoAlt} className="h-10 w-auto" width={40} height={40} />
          ...
          {updatedColumns.map((column) => (
            <div key={column.title}>
              <h3 className="text-lg font-bold mb-4 border-b border-gray-800 pb-2">{column.title}</h3>
                        ...
                        onClick={() => {
                          if (typeof navigator !== "undefined" && navigator.clipboard) {
                            navigator.clipboard
                              ...
                              .then(() => {
                                alert(`Phone number copied: ${link.phoneNumber}`)
                              })
                              .catch(() => {
                                alert(`Please copy this number: ${link.phoneNumber}`)
                              })
                          } else {
                            alert(`Please copy this number: ${link.phoneNumber}`)
                          }
          ...
          {newsletter && (
            <div>
              <h3 className="text-lg font-bold mb-4 border-b border-gray-800 pb-2">Subscribe</h3>
              ...
              >
                ...
                <ChevronDown
                  className={cn(
                    ...
                    activeAccordion === column.title ? "transform rotate-180" : "",
                  )}
                />
              </button>
              <div
                className={cn(
                  ...
                  activeAccordion === column.title ? "max-h-96 opacity-100" : "max-h-0 opacity-0",
                )}
              >
