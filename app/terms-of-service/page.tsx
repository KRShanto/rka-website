          ...
          <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 md:p-8">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p>
                ...
                ARE EXPRESSLY PROHIBITED FROM USING THE WEBSITE AND SERVICES AND
              ...
              <ol>
                ...
                <li>
                  You will not access the website or services through automated
              ...
              <p>
                ...
                and account information for all purchases made via the website.
              ...
              <p>
                ...
                specified in our refund policy. Please review our refund policy
                before making a purchase.
              </p>
              <p>
                For membership cancellations, you must provide written notice at
                least 30 days before the next billing cycle. Failure to do so
                may result in charges for the next billing cycle.
              </p>
              ...
              <ol>
                ...
                <li>
                  Engage in unauthorized framing of or linking to the website or
                  services.
                </li>
                <li>
              ...
              <p>
                ...
                OTHER DAMAGES ARISING FROM YOUR USE OF THE WEBSITE OR SERVICES,
              ...
              <p>
                ...
                arising out of: (1) your use of the website or services; (2)
                breach of these Terms of Service; (3) any breach of your
                ...
                (5) any overt harmful act toward any other user of the website
                or services with whom you connected via the website or services.
              </p>

              <h2>Term and Termination</h2>
              <p>
                These Terms of Service shall remain in full force and effect
                while you use the website or services. WITHOUT LIMITING ANY
                ...
                ACCESS TO AND USE OF THE WEBSITE AND SERVICES (INCLUDING
                ...
                OF SERVICE OR OF ANY APPLICABLE LAW OR REGULATION.
              </p>

              <h2>Changes to Terms of Service</h2>
              <p>
                We reserve the right to change, modify, or remove the contents
                of these Terms of Service at any time or for any reason at our
                sole discretion without notice. It is your responsibility to
                check these Terms of Service periodically for changes. Your
                continued use of the website or services following the posting
                of revised Terms of Service means that you accept and agree to
                the changes.
              </p>
