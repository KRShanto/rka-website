...
import { getProfileById, type BlackBeltProfile } from "@/lib/data/black-belt-profiles"
    ...
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mb-6">The black belt profile you are looking for does not exist.</p>
      ...
      <section className="bg-primary dark:bg-gray-900 text-primary-foreground py-20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div>
              <h1 className="text-4xl font-bold mb-2 dark:text-white">{profile.fullName}</h1>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
                <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white border-b pb-2">Achievements</h2>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white border-b pb-2">Karate Journey</h2>
                <div className="mb-4">
                  <div className="flex items-start gap-3 mb-4">
                    <Clock className="w-5 h-5 mt-0.5 text-[#dc2626]" />
                    <div>
                      <p className="font-medium text-gray-700 dark:text-gray-300">Joined BWKD</p>
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <p className="font-medium text-gray-700 dark:text-gray-300">Current Rank</p>
                  </div>

                  <div className="ml-8 space-y-4 border-l-2 border-primary/30 pl-4">
                    {/* Generate previous dan ranks based on current rank */}
                    {Array.from({ length: Number.parseInt(profile.dan.split("")[0]) }, (_, i) => i + 1).map((dan) => (
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                          ...
                          {new Date(
                            new Date(profile.blackBeltDate).getTime() -
                              (Number.parseInt(profile.dan.split("")[0]) - dan) * 3 * 365 * 24 * 60 * 60 * 1000,
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400">{profile.fullName}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-700 dark:text-gray-300">Birthday</p>
                      <p className="text-gray-600 dark:text-gray-400">{profile.birthday}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <Award className="w-5 h-5 mt-0.5 text-[#dc2626]" />
                    <div>
                      <p className="font-medium text-gray-700 dark:text-gray-300">BWKD ID</p>
                      <p className="text-gray-600 dark:text-gray-400">{profile.userId}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 text-center">
            <Link href="/black-belts">
              <Button className="bg-primary hover:bg-primary/90">Back to All Black Belts</Button>
            </Link>
          </div>
        </div>
      </section>
